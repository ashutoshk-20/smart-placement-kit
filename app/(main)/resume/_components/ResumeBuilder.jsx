...
const ResumeBuilder = ({ initalContent }) => {
    ...
    useEffect(() => {
        if (initalContent) setActiveTab("preview");
    }, [initalContent]);

    useEffect(() => {
        if (activeTab === "edit") {
            const newContent = getCombinedContent();
            setPreviewContent(newContent ? newContent : initalContent);
        }
        ...
        try {
            ...
            const opt = {
                ...
                html2canvas: {
                    ...
                    onclone: (clonedDoc) => {
                        // Remove any elements or styles that might cause lab() or oklch() issues
