...
export const generateeAIInsights = async (industry) => {
    const prompt = `
...
export async function getIndustryInsights() {
    ...
    if (!user.industryInsight) {
        const insights = await generateeAIInsights(user.industry);
    ...
    return JSON.parse(JSON.stringify(user.industryInsight));
}